...
namespace Catarinum.Tests.Coap {
    ...
    public class ResponseTests {
        ...
        public void Should_have_valid_code_registry() {
            new Response(MessageType.Confirmable, CodeRegistry.Empty);
        }

        [Test]
        public void Confirmable_message_should_carry_response() {
            var response = new Response(MessageType.Confirmable, CodeRegistry.Created);
        ...
        public void Reset_message_should_not_carry_response() {
            new Response(MessageType.Reset, CodeRegistry.Created);
        }
